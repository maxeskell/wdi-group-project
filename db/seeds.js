...
.then((users) => {
  ...
  .create([{
    ...
    difficulty: 1,
    image: 'https://sites.psu.edu/siowfa14/wp-content/uploads/sites/13467/2014/10/Men-and-Women-walking_cropped.jpg',
    createdBy: users[0],
    length: 5.5,
    time: '01:45',
    route: [{
    ...
    difficulty: 2,
    image: 'https://img.mp.itc.cn/upload/20170314/9052b6c3e8264d8caafa5e89568f76eb_th.jpeg',
    createdBy: users[1],
    length: 5.5,
    time: '01:45',
    route: [{
