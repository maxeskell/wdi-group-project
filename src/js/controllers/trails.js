...
TrailsShowCtrl.$inject = ['Trail', '$state', 'TrailComment', 'User', '$auth', 'darksky'];

function TrailsShowCtrl(Trail, $state, TrailComment, User, $auth, darksky) {
  const vm = this;
  vm.newComment = {};
  vm.user = {};
